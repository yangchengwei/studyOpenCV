...
// OpenCv_homework2.cpp : 定義應用程式的類別行為。
//
...
BEGIN_MESSAGE_MAP(COpenCv_homework2App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// COpenCv_homework2App 建構

COpenCv_homework2App::COpenCv_homework2App()
{
	// 支援重新啟動管理員
...
// 僅有的一個 COpenCv_homework2App 物件

COpenCv_homework2App theApp;


// COpenCv_homework2App 初始設定

BOOL COpenCv_homework2App::InitInstance()
{

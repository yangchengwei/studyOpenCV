...
BEGIN_MESSAGE_MAP(CCv_homework2App, CWinApp)
...
CCv_homework2App::CCv_homework2App()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CCv_homework2App 物件

CCv_homework2App theApp;


// CCv_homework2App 初始設定

BOOL CCv_homework2App::InitInstance()
{

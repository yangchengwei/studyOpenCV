...
// OpenCv_homework1.cpp : 定義應用程式的類別行為。
//
...
BEGIN_MESSAGE_MAP(COpenCv_homework1App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// COpenCv_homework1App 建構

COpenCv_homework1App::COpenCv_homework1App()
{
	// 支援重新啟動管理員
...
// 僅有的一個 COpenCv_homework1App 物件

COpenCv_homework1App theApp;


// COpenCv_homework1App 初始設定

BOOL COpenCv_homework1App::InitInstance()
{
